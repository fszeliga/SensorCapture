...
/**
 * Created by telepresence on 16.11.2016.
 */
...
public class Camera2Fragment extends Fragment {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            // save picture
            mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), new File(imageDirectory ,System.currentTimeMillis() + ".jpg")));
            // take next picture
            lockFocus();
        }
     ...
     */
    public void takePictures(File imageDirectory) {
